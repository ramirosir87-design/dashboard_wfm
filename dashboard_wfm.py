    ...
    try:
        ...
        def cargar_y_procesar_crudo(file):
            ...
            for df in [df_staff, df_break, df_bano, df_nov, df_capa, df_ch, df_dec]:
                ...
                # Convert key columns to strings early to avoid sorting conflicts (e.g. integer 925 and string '-') and PyArrow table serialization issues.
                key_cols = ['ID', 'Asesor', 'DNI', 'SUPERVISOR', 'PLATAFORMA', 'SKILL', 'PROG SIMPLEX', 'Facturacion', 'BREAK PROG', 'BREAK Real', 'Horario PROG', 'Horario Log', 'PROGRAMADO', 'ACUMULADO']
                for col in key_cols:
